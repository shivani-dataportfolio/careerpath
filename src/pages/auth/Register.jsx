...
import { User, Mail, Lock, BrainCircuit, AlertCircle, Eye, EyeOff } from 'lucide-react';
...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (errorCode === 'auth/email-already-in-use') message = 'An account with this email already exists.';
            if (errorCode === 'auth/invalid-email') message = 'The email address is not valid.';
            if (errorCode === 'auth/operation-not-allowed') message = 'Email/password accounts are not enabled.';
            if (errorCode === 'auth/weak-password') message = 'The password is too weak (min 6 characters).';
            ...
            <div className="w-full max-w-md">
                ...
                <Card className="p-8 shadow-2xl border-none">
                    <CardHeader className="text-center mb-8">
                        ...
                        <p className="text-slate-500 font-medium">Join professionals using AI to scale their careers.</p>
                    </CardHeader>
                    <CardContent>
